...
3. Only after you have deliberated on all instructions, call `next_step` to proceed to the next node in the plan. If the tool fails and provides branch names in the error message, choose the appropriate branch based on your deliberation by passing it to your `next_step` call.
